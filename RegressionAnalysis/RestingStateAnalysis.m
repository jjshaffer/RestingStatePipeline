%Script for running regression analysis of Resting State data. 
%Author: Joe Shaffer
%Date: June 2017

function x = RestingStateAnalysis(CovarFile, DataFile, OutPrefix, NullModel, ExpModel, ExpVar)
...
batchRestingStateContrast(CovarFile, DataFile, OutPrefix, NullModel, ExpModel, ExpVar);
